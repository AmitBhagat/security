...
"orderId","orderReferenceId","timeStamp","userId","restaurantName","restaurantAddress","deliveryAddress","dishNameList","dishTotalQuantity","orderDiscount","sumAmount",
"tax","totalAmount","paymentMode","paymentStatus","orderStatus","suggestions","suggestionDishList"})
@ApiModel(description = "All details about the Dish Name Response")
public class OrderResponse implements Serializable {
	private static final long serialVersionUID = -8782352348857382409L;
